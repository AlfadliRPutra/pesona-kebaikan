...
export default async function SettingsPage() {
  ...
  const emailSettings = {
    email_sender: getVal("email_sender") ?? (process.env.EMAIL_FROM || process.env.EMAIL_SERVER_USER || ""),
    email_app_password: getVal("email_app_password") ?? (process.env.EMAIL_SERVER_PASSWORD || ""),
    email_verification_subject: getVal("email_verification_subject") ?? "Kode Verifikasi Email - Pesona Kebaikan",
    email_verification_content: getVal("email_verification_content") ?? defaultContent,
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
        ...
        <p className="text-sm text-gray-500 mb-6">
          Konfigurasi pengirim email, password aplikasi (SMTP), subjek, dan template isi email verifikasi.
        </p>
