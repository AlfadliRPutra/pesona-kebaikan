    ...
    <Box sx={{ px: 2, pt: 2.5 }}>
      ...
      >
        ...
        >
          ...
          <IconButton onClick={() => setOpenVerification(false)} sx={{ position: "absolute", top: 8, right: 8, color: "white" }}>
            <CloseIcon />
          </IconButton>
        </Box>
            ...
            <Step>
              ...
              <StepContent>
                <Alert severity="info" sx={{ mb: 2, borderRadius: 2 }}>
                  Kode verifikasi akan dikirim ke <b>{user?.email || "email anda"}</b>
                </Alert>
                <Stack direction="row" spacing={1} sx={{ mb: 2 }}>
                  <TextField size="small" placeholder="Masukkan Kode OTP" fullWidth InputProps={{ sx: { borderRadius: 2 } }} />
                  <Button
                    variant="outlined"
                    sx={{
                      borderRadius: 2,
